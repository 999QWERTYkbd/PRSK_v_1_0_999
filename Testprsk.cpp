...
int main()
{
    ...
    do {
        ...
        if (k == 11) {
            ...
            cout << "Invalid Range! \x1b[38;2;255;0;0mPlease Enter A VALID VALUE.\x1b[38;2;255;255;255m\n";
        ...
        cout << "\n";
            ...
            if (100 <= base12 && base12 <= 130) {
                ...
                cout << "Invalid Range! \x1b[38;2;255;0;0mPlease Enter A VALID VALUE.\x1b[m\n";
            ...
            cout << "他のプレイヤーのスコアは0か、4420000以上ですか? 0:0 4420000以上:9 ALL:1\n";
            cin >> e;
        ...
        //番外編
            ...
            cout << "\n\x1b[38;2;255;0;0m必ず自己責任でご利用ください.\x1b[m\n";
            cout << "ある程度の動作は保障しますが、このツールの利用によって得た不利益や被害については一切責任を負いません, \n";
            cout << "\n";
            cout << "\x1b[38;2;255;0;0m使い方\x1b[m\n";
            ...
            cout << "\n";
            cout << "\x1b[38;2;255;0;0m注意事項\x1b[m\n";
            ...
            cout << "139モードになります \x1b[38;2;13;56;206mエラーメッセージが出るまで文字色が変わります\n\n";
        }

        else if (k == 2539) {
            cout << "2539モードになります 背景色を変更しますか? Yes:0 No:1 RESET:9\n";
            int p;
            cin >> p;
            switch (p) {
            case 0:
                cout << "R G Bの順番で数値を入力してください (0-255?)\n";
                int q1, q2, q3;
                cout << "R?";
                cin >> q1;
                cout << "G?";
                ...
                cout << "B?";
                cin >> q3;
                if (q1 > 0 && q1 < 255 && q2 > 0 && q2 < 255 && q3 > 0 && q3 < 255) {
                    cout << "\x1b[48;2;" << q1 << ";" << q2 << ";" << q3 << "m背景色をこの色に変更しますか?\x1b[0m Yes:0 No:1\n";
                    int r;
                    cin >> r;
                    if (r == 0) {
                        cout << "\x1b[48;2;" << q1 << ";" << q2 << ";" << q3 << "m" << "R:" << q1 << " G:" << q2 << " B:" << q3 << "に背景色を変更しました\n";
                    }
                    else {
                        cout << "取り消しました\n";
                    }
            ...
            case 1:
                ...
                break;
            case 9:
                cout << "背景色をリセットしますか? Yes:0 No:1\n";
                int r;
                cin >> r;
                if (r == 0) {
                    cout << "\x1b[0m背景色をリセットしました\n";
                }
                else {
                    cout << "取り消しました\n";
                }
